...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configpasswordunmask('vitero/adminpassword',
                    get_string('adminpassword', 'vitero'), get_string('adminpassword_desc', 'vitero'), ''));
    $settings->add(new admin_setting_configtext('vitero/hostname',
                    get_string('hostname', 'vitero'), get_string('hostname_desc', 'vitero'), ''));
    $settings->add(new admin_setting_configtext('vitero/port',
                    get_string('port', 'vitero'), get_string('port_desc', 'vitero'), '80'));
    $settings->add(new admin_setting_configtext('vitero/root',
                    get_string('root', 'vitero'), get_string('root_desc', 'vitero'), 'vitero'));
    $settings->add(new admin_setting_configtext('vitero/customername',
                    get_string('customername', 'vitero'), get_string('customername_desc', 'vitero'), ''));
    $settings->add(new admin_setting_configtext('vitero/customerlicense',
                    get_string('customerlicense', 'vitero'), get_string('customerlicense_desc', 'vitero'), ''));
